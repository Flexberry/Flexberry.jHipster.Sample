...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-05-30T08:27').blur().should('have.value', '2023-05-30T08:27');

      cy.get(`[data-cy="endDate"]`).type('2023-05-29T15:25').blur().should('have.value', '2023-05-29T15:25');
