...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Глобальный коммуникационный агент').should('have.value', 'Глобальный коммуникационный агент');

      cy.get(`[data-cy="minSalary"]`).type('4726').should('have.value', '4726');
